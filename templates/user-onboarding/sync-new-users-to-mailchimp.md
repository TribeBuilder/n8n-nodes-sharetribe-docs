...
<ClientOnly>
  <TemplateActions slug="sync-new-users-to-mailchimp" category="user-onboarding" source-url="https://github.com/tribebuilder/n8n-nodes-sharetribe/blob/main/workflows/public-templates/published/user-onboarding/sync-new-users-to-mailchimp.json" screenshot="/img/templates/sync-new-users-to-mailchimp.png" />
</ClientOnly>
